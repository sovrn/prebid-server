...
func init() {
	...
	viper.SetDefault("adapters.sovrn.endpoint", "http://vpod7q.qa.lijit.com/rtb/bid?src=prebid_server")
	viper.SetDefault("adapters.sovrn.usersync_url", "http://localhost:8080/pixel?")
